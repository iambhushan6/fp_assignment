...
def fetch_youtube_data():
    ...
    youtube_url = f"https://www.googleapis.com/youtube/v3/search?q={search_query}&order=date&publishedAfter={published_after_timestamp}&maxResults=100&part=snippet&key={settings.YOU_TUBE_API_KEY}"
